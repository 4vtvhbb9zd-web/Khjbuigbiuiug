...
<body>
        ...
        <div class="content">
            ...
            <div class="video-section">
                <div class="video-container">
                    ...
                    <button style="margin-top: 10px;" id="video-btn">تشغيل الفيديو</button>
                </div>
    ...
    <script>
        ...
        function updateNavigation() {
            ...
            // إذا أجاب المستخدم على جميع الأسئلة، احسب النتيجة
        ...
        function playVideo() {
            alert("سيتم تشغيل فيديو شرح درس المول. في التطبيق الحقيقي، سيتم تضمين فيديو حقيقي هنا.");
        }
